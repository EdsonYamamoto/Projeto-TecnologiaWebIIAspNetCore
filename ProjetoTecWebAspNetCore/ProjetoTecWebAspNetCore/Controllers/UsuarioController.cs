...
namespace ProjetoTecWebAspNetCore.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Email,Senha,DataNascimento,Nome,Obs")] UsuarioModel usuarioModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Email,Senha,DataNascimento,Nome,Obs")] UsuarioModel usuarioModel)
        {
